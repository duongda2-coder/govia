...
export function CmNtd10Page() {
  ...
  const columns: TableProps<AuditCmNtd10Item>["columns"] = [
    { title: t("auditCmNtd10.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd10.columns.issueDate"), width: 120, ...getSearchColumnProps("issueDate", searchLabels) },
    { title: t("auditCmNtd10.columns.customerCode"), width: 140, ...getSearchColumnProps("customerCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.customerName"), ...getSearchColumnProps("customerName", searchLabels) },
    { title: t("auditCmNtd10.columns.accountNumber"), width: 150, ...getSearchColumnProps("accountNumber", searchLabels) },
    { title: t("auditCmNtd10.columns.cardTier"), width: 110, ...getSearchColumnProps("cardTier", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.issuingUser"), width: 130, ...getSearchColumnProps("issuingUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.issuanceFee"), dataIndex: "issuanceFee", width: 140, align: "right", sorter: (a, b) => num(a.issuanceFee, b.issuanceFee), render: money },
    { title: t("auditCmNtd10.columns.issuanceType"), width: 150, ...getSearchColumnProps("issuanceType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.issuanceOccurrence"), width: 130, ...getSearchColumnProps("issuanceOccurrence", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.sampleReason"), width: 130, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.recommendationType"), ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.transactionStaff"), ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.controlUser"), ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.controlStaff"), ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd10.columns.controlStaffTitle"), ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
