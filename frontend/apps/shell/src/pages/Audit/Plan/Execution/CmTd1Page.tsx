...
export function CmTd1Page() {
  ...
  const columns: TableProps<AuditCmTd1Item>["columns"] = [
    { title: t("auditCmTd1.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmTd1.columns.auditDate"), width: 120, ...getSearchColumnProps("auditDate", searchLabels) },
    { title: t("auditCmTd1.columns.customerCode"), width: 140, ...getSearchColumnProps("customerCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.sampleFilterUser"), width: 130, ...getSearchColumnProps("sampleFilterUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.customerName"), ...getSearchColumnProps("customerName", searchLabels) },
    { title: t("auditCmTd1.columns.approvedAmount"), dataIndex: "approvedAmount", width: 150, align: "right", sorter: (a, b) => num(a.approvedAmount, b.approvedAmount), render: money },
    { title: t("auditCmTd1.columns.loanPurpose"), ...getSearchColumnProps("loanPurpose", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.description"), ...getSearchColumnProps("description", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.onBalanceDebt"), dataIndex: "onBalanceDebt", width: 140, align: "right", sorter: (a, b) => num(a.onBalanceDebt, b.onBalanceDebt), render: money },
    { title: t("auditCmTd1.columns.guaranteeBalance"), dataIndex: "guaranteeBalance", width: 140, align: "right", sorter: (a, b) => num(a.guaranteeBalance, b.guaranteeBalance), render: money },
    { title: t("auditCmTd1.columns.riskClassifiedDebt"), dataIndex: "riskClassifiedDebt", width: 140, align: "right", sorter: (a, b) => num(a.riskClassifiedDebt, b.riskClassifiedDebt), render: money },
    { title: t("auditCmTd1.columns.vamcSoldDebt"), dataIndex: "vamcSoldDebt", width: 140, align: "right", sorter: (a, b) => num(a.vamcSoldDebt, b.vamcSoldDebt), render: money },
    { title: t("auditCmTd1.columns.totalCreditBalance"), dataIndex: "totalCreditBalance", width: 150, align: "right", sorter: (a, b) => num(a.totalCreditBalance, b.totalCreditBalance), render: money },
    { title: t("auditCmTd1.columns.debtGroup"), width: 100, ...getSearchColumnProps("debtGroup", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.auditScope"), ...getSearchColumnProps("auditScope", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.auditorCode"), width: 130, ...getSearchColumnProps("auditorCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.sampleReason"), width: 130, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd1.columns.note"), ...getSearchColumnProps("note", searchLabels), render: (v: string | null) => v ?? "-" },
    {
