...
export function CmTd2Page() {
  ...
  const columns: TableProps<AuditCmTd2Item>["columns"] = [
    { title: t("auditCmTd2.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmTd2.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmTd2.columns.valueDate"), width: 120, ...getSearchColumnProps("valueDate", searchLabels) },
    { title: t("auditCmTd2.columns.postingUser"), width: 120, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmTd2.columns.entryNumber"), dataIndex: "entryNumber", width: 120, align: "right", sorter: (a, b) => num(a.entryNumber, b.entryNumber), render: money },
    { title: t("auditCmTd2.columns.customerCode"), width: 140, ...getSearchColumnProps("customerCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.customerName"), ...getSearchColumnProps("customerName", searchLabels) },
    { title: t("auditCmTd2.columns.disbursementNumber"), width: 140, ...getSearchColumnProps("disbursementNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.businessCode"), width: 130, ...getSearchColumnProps("businessCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.transactionStatus"), width: 140, ...getSearchColumnProps("transactionStatus", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.currency"), width: 90, ...getSearchColumnProps("currency", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.debitAmount"), dataIndex: "debitAmount", width: 150, align: "right", sorter: (a, b) => num(a.debitAmount, b.debitAmount), render: money },
    { title: t("auditCmTd2.columns.creditAmount"), dataIndex: "creditAmount", width: 150, align: "right", sorter: (a, b) => num(a.creditAmount, b.creditAmount), render: money },
    { title: t("auditCmTd2.columns.accountNumber"), width: 130, ...getSearchColumnProps("accountNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.postingDateDiff"), dataIndex: "postingDateDiff", width: 140, align: "right", sorter: (a, b) => num(a.postingDateDiff, b.postingDateDiff), render: money },
    { title: t("auditCmTd2.columns.ipcasReviewResult"), ...getSearchColumnProps("ipcasReviewResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmTd2.columns.documentCheckResult"), ...getSearchColumnProps("documentCheckResult", searchLabels), render: (v: string | null) => v ?? "-" },
    {
