...
export function CmNtd16Page() {
  ...
  const columns: TableProps<AuditCmNtd16Item>["columns"] = [
    { title: t("auditCmNtd16.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd16.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmNtd16.columns.postingUser"), width: 130, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmNtd16.columns.entryNumber"), dataIndex: "entryNumber", width: 140, align: "right", sorter: (a, b) => num(a.entryNumber, b.entryNumber), render: money },
    { title: t("auditCmNtd16.columns.debitAmount"), dataIndex: "debitAmount", width: 150, align: "right", sorter: (a, b) => num(a.debitAmount, b.debitAmount), render: money },
    { title: t("auditCmNtd16.columns.creditAmount"), dataIndex: "creditAmount", width: 150, align: "right", sorter: (a, b) => num(a.creditAmount, b.creditAmount), render: money },
    { title: t("auditCmNtd16.columns.transactionStatus"), width: 140, ...getSearchColumnProps("transactionStatus", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.currency"), width: 100, ...getSearchColumnProps("currency", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.accountNumber"), width: 140, ...getSearchColumnProps("accountNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.content"), ...getSearchColumnProps("content", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.sampleReason"), width: 130, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.recommendationType"), ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.transactionStaff"), ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.controlUser"), ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.controlStaff"), ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd16.columns.controlStaffTitle"), ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
