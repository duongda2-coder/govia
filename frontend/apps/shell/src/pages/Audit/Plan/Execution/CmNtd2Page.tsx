...
export function CmNtd2Page() {
  ...
  const columns: TableProps<AuditCmNtd2Item>["columns"] = [
    { title: t("auditCmNtd2.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd2.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmNtd2.columns.valueDate"), width: 120, ...getSearchColumnProps("valueDate", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.postingUser"), width: 120, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmNtd2.columns.entryNumber"), dataIndex: "entryNumber", width: 120, align: "right", sorter: (a, b) => num(a.entryNumber, b.entryNumber), render: money },
    { title: t("auditCmNtd2.columns.currency"), width: 90, ...getSearchColumnProps("currency", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.amount"), dataIndex: "amount", width: 150, align: "right", sorter: (a, b) => num(a.amount, b.amount), render: money },
    { title: t("auditCmNtd2.columns.accountNumber"), width: 130, ...getSearchColumnProps("accountNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.bookNumber"), width: 130, ...getSearchColumnProps("bookNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.transactionType"), width: 130, ...getSearchColumnProps("transactionType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.transactionStatus"), width: 140, ...getSearchColumnProps("transactionStatus", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.sampleReason"), width: 160, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.recommendationType"), width: 150, ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.transactionStaff"), width: 150, ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.controlUser"), width: 130, ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.controlStaff"), width: 150, ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd2.columns.controlStaffTitle"), width: 170, ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
