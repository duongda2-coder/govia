...
export function CmNtd8Page() {
  ...
  const columns: TableProps<AuditCmNtd8Item>["columns"] = [
    { title: t("auditCmNtd8.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd8.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmNtd8.columns.referenceNumber"), width: 140, ...getSearchColumnProps("referenceNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.postingUser"), width: 140, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmNtd8.columns.entryNumber"), dataIndex: "entryNumber", width: 120, align: "right", sorter: (a, b) => num(a.entryNumber, b.entryNumber), render: money },
    { title: t("auditCmNtd8.columns.amount"), dataIndex: "amount", width: 150, align: "right", sorter: (a, b) => num(a.amount, b.amount), render: money },
    { title: t("auditCmNtd8.columns.currency"), width: 90, ...getSearchColumnProps("currency", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.orderingParty"), ...getSearchColumnProps("orderingParty", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.beneficiaryParty"), ...getSearchColumnProps("beneficiaryParty", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.beneficiaryAccount"), width: 150, ...getSearchColumnProps("beneficiaryAccount", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.sampleReason"), width: 140, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.recommendationType"), ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.transactionStaff"), ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.controlUser"), ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.controlStaff"), ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd8.columns.controlStaffTitle"), ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
