...
export function CmNtd12Page() {
  ...
  const load = useCallback(
    async (selectedEngagementId: string) => {
      setLoading(true);
      try {
        setItems(await listAuditCmNtd12(selectedEngagementId));
      } catch {
  ...
  const columns: TableProps<AuditCmNtd12Item>["columns"] = [
    { title: t("auditCmNtd12.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd12.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmNtd12.columns.postingUser"), width: 130, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmNtd12.columns.entryNumber"), dataIndex: "entryNumber", width: 140, align: "right", sorter: (a, b) => num(a.entryNumber, b.entryNumber), render: money },
    { title: t("auditCmNtd12.columns.debitAmount"), dataIndex: "debitAmount", width: 150, align: "right", sorter: (a, b) => num(a.debitAmount, b.debitAmount), render: money },
    { title: t("auditCmNtd12.columns.creditAmount"), dataIndex: "creditAmount", width: 150, align: "right", sorter: (a, b) => num(a.creditAmount, b.creditAmount), render: money },
    { title: t("auditCmNtd12.columns.transactionStatus"), width: 140, ...getSearchColumnProps("transactionStatus", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.currency"), width: 100, ...getSearchColumnProps("currency", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.accountNumber"), width: 140, ...getSearchColumnProps("accountNumber", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.content"), ...getSearchColumnProps("content", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.sampleReason"), width: 130, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.recommendationType"), ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.transactionStaff"), ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.controlUser"), ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.controlStaff"), ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.controlStaffTitle"), ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
  ...
  return (
    <div>
      ...
      <CrudTable<AuditCmNtd12Item>
        ...
        onExportExcel={canExport && engagementId ? () => exportAuditCmNtd12("excel", engagementId) : undefined}
        onExportWord={canExport && engagementId ? () => exportAuditCmNtd12("word", engagementId) : undefined}
        onImport={
          canImport && engagementId
            ? async (file) => {
                const result = await importAuditCmNtd12(engagementId, file);
                await load(engagementId);
                return result;
              }
            : undefined
      ...
      >
        <Form<FormValues> form={form} layout="vertical">
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item name="assignedEmployeeId" label={t("auditCmNtd12.columns.assignedUsername")}>
                <Select
                  allowClear
                  showSearch
                  optionFilterProp="label"
            ...
            <Col span={12}>
              <Form.Item name="processStepSummaryId" label={t("auditCmNtd12.columns.processStepSummaryCode")}>
                <Select
                  allowClear
                  showSearch
                  optionFilterProp="label"
