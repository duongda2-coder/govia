...
export function CmNtd12Page() {
  ...
  const columns: TableProps<AuditCmNtd12Item>["columns"] = [
    { title: t("auditCmNtd12.columns.assignedUsername"), dataIndex: "assignedUsername", width: 150, render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd12.columns.processStepSummaryCode"), dataIndex: "processStepSummaryCode", width: 130, render: (v: string | null) => v ?? "-" },
