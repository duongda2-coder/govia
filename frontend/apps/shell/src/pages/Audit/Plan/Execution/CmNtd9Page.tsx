...
export function CmNtd9Page() {
  ...
  const columns: TableProps<AuditCmNtd9Item>["columns"] = [
    { title: t("auditCmNtd9.columns.assignedUsername"), width: 150, ...getSearchColumnProps("assignedUsername", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.processStepSummaryCode"), width: 130, ...getSearchColumnProps("processStepSummaryCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.branchCode"), width: 110, ...getSearchColumnProps("branchCode", searchLabels) },
    { title: t("auditCmNtd9.columns.transactionDate"), width: 130, ...getSearchColumnProps("transactionDate", searchLabels) },
    { title: t("auditCmNtd9.columns.postingUser"), width: 130, ...getSearchColumnProps("postingUser", searchLabels) },
    { title: t("auditCmNtd9.columns.customerCode"), width: 140, ...getSearchColumnProps("customerCode", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.customerName"), ...getSearchColumnProps("customerName", searchLabels) },
    { title: t("auditCmNtd9.columns.customerType"), width: 130, ...getSearchColumnProps("customerType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.transactionContent"), ...getSearchColumnProps("transactionContent", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.sampleReason"), width: 130, ...getSearchColumnProps("sampleReason", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.auditResult"), ...getSearchColumnProps("auditResult", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.recommendationType"), ...getSearchColumnProps("recommendationType", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.transactionStaff"), ...getSearchColumnProps("transactionStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.controlUser"), ...getSearchColumnProps("controlUser", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.controlStaff"), ...getSearchColumnProps("controlStaff", searchLabels), render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd9.columns.controlStaffTitle"), ...getSearchColumnProps("controlStaffTitle", searchLabels), render: (v: string | null) => v ?? "-" },
    {
