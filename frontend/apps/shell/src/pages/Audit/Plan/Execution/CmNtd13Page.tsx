...
export function CmNtd13Page() {
  ...
  const columns: TableProps<AuditCmNtd13Item>["columns"] = [
    { title: t("auditCmNtd13.columns.assignedUsername"), dataIndex: "assignedUsername", width: 150, render: (v: string | null) => v ?? "-" },
    { title: t("auditCmNtd13.columns.processStepSummaryCode"), dataIndex: "processStepSummaryCode", width: 130, render: (v: string | null) => v ?? "-" },
