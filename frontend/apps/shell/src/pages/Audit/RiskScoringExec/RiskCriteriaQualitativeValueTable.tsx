  ...
  return (
    <div>
      ...
      <CrudTable<RiskCriteriaQualitativeValueItem>
        ...
        onExportExcel={canExport && year != null ? () => riskCriteriaQualitativeValueApi.exportFile(year, "excel") : undefined}
        onExportWord={canExport && year != null ? () => riskCriteriaQualitativeValueApi.exportFile(year, "word") : undefined}
        onImport={
          canImport
            ? async (file) => {
