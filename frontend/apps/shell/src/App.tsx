...
import { TdkpAssignmentPage } from "./pages/Audit/Tdkp/TdkpAssignmentPage";
import { TdkpCeoPage } from "./pages/Audit/Tdkp/TdkpCeoPage";
import { TdkpBranchPage } from "./pages/Audit/Tdkp/TdkpBranchPage";
...
import { AuditEngagementMonitoringPage } from "./pages/Audit/Plan/Engagement/AuditEngagementMonitoringPage";
import { AuditSupervisionTeamManagementPage } from "./pages/Audit/Plan/Engagement/AuditSupervisionTeamManagementPage";
import { AuditProcessEngagementPage } from "./pages/Audit/Plan/Engagement/ProcessEngagement/AuditProcessEngagementPage";
import { AuditStatisticsPage } from "./pages/Audit/Plan/Engagement/AuditStatisticsPage";
...
import { CmNtd15Page } from "./pages/Audit/Plan/Execution/CmNtd15Page";
import { CmNtd16Page } from "./pages/Audit/Plan/Execution/CmNtd16Page";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="audit/tdkp/assignment" element={<TdkpAssignmentPage />} />
          <Route path="audit/tdkp/ceo-all" element={<TdkpCeoPage variant="all" />} />
          <Route path="audit/tdkp/ceo-kh" element={<TdkpCeoPage variant="kh" />} />
          <Route path="audit/tdkp/branch" element={<TdkpBranchPage />} />
          ...
          <Route path="audit/plan/engagement/supervision-team" element={<AuditSupervisionTeamManagementPage />} />
          <Route path="audit/plan/engagement/process" element={<AuditProcessEngagementPage />} />
          <Route path="audit/plan/engagement/statistics" element={<AuditStatisticsPage />} />
          ...
          <Route path="audit/plan/execution/cm-ntd15" element={<CmNtd15Page />} />
          <Route path="audit/plan/execution/cm-ntd16" element={<CmNtd16Page />} />
