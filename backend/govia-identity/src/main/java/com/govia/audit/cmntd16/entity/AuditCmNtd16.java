package com.govia.audit.cmntd16.entity;
...
/** Man hinh "Danh sach cac but toan chon mau nghiep vu HDV" (sheet ZTC_CM_NTD16, phu luc 03G/BKS-KTNB) -
 * trong nhom "Thuc hien kiem toan" cua "Lap ke hoach", module Kiem toan noi bo. Cung cau truc voi
 * AuditCmNtd1 (04C/GA)/AuditCmNtd12 (07F/CD)/AuditCmNtd15 (05D/MF) - ZTC_CM_NTD15,16.xlsx nguoi dung
 * cung cap co cung bang cot voi cac sheet do. Cac cot kieu "List" tham chieu du lieu IPCAS chua co
 * danh muc tuong ung trong GOVIA nen duoc luu la String tu do, khong FK - cung quy uoc voi AuditCmTd1.
 * engagementId/assignedEmployeeId/processStepSummaryId them de loc theo Cuoc kiem toan (giong bo loc
 * Nam ben Cham diem rui ro) + theo doi nguoi phu trach. */
@Getter
@Setter
@Entity
@Table(name = "audit_cm_ntd16")
public class AuditCmNtd16 extends BaseEntity {
