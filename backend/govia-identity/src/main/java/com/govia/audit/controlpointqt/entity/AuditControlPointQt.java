package com.govia.audit.controlpointqt.entity;
...
/** Danh muc "Chot kiem soat quy trinh" (sheet ZTC_CKS_QT, bang ZTB_CKS_Qt) - phien ban "Kiem
 * toan quy trinh" cua danh muc Chot kiem soat (AuditControlPoint/ZTC_CKS), tach bang rieng. Cung
 * cau truc voi AuditControlPoint. */
@Getter
@Setter
@Entity
@Table(name = "audit_control_point_qt")
public class AuditControlPointQt extends BaseEntity {
