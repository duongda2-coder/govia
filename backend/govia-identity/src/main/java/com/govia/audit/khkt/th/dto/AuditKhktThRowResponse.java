...
/** Dung chung cho ca danh sach Phan 1 (TH) va Phan 2 (TH2 - da xac nhan). "proposingDepartmentCodes"
 * va "bpProposedSegmentCodes" tinh dong tu AuditKhktBpConfirmed (BP2) - danh sach phong da de xuat
