...
import com.govia.audit.riskscoring.masterdata.service.MatrixService;
...
/** Man hinh "Ma tran diem rui ro" cua sub-module Master Data CDRR (module Cham diem rui ro) (xem MatrixService). */
@RestController
@RequestMapping("/api/audit/risk-scoring/master-data/matrix")
public class MatrixController {
    ...
    public ApiResponse<List<MatrixResponse>> list() {
        return ApiResponse.ok(service.list());
    }

    @PostMapping
    @PreAuthorize("hasAuthority('PERM_AUDIT.RISK_SCORING.CREATE')")
    public ApiResponse<MatrixResponse> create(@Valid @RequestBody MatrixRequest request) {
        return ApiResponse.ok(service.create(request));
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('PERM_AUDIT.RISK_SCORING.EDIT')")
    public ApiResponse<MatrixResponse> update(@PathVariable UUID id, @Valid @RequestBody MatrixRequest request) {
    ...
    public ResponseEntity<byte[]> exportExcel() {
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"risk_score_matrix.xlsx\"")
    ...
    public ResponseEntity<byte[]> exportWord() {
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"risk_score_matrix.docx\"")
